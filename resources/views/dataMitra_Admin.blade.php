...
<html lang="en">
  ...
  <body>
    ...
    <a href="/daftarAdmin" class="btn btn-outline danger mb-2" style="margin-right: 10px; font-weight: bold;">Daftar Admin</a>
    ...
    <div class="container">
      <div class="feature">
        <a href="/daftarMitra_Admin" type="button" class="btn btn-outline-danger mb-2">
    ...
    <div class="row">
      <div class="col-sm">
        <form action="/daftarMitra_Admin" method="get">
